...
// All implementations should embed UnimplementedMetadataStoreServiceServer
...
// UnimplementedMetadataStoreServiceServer should be embedded to have forward compatible implementations.
